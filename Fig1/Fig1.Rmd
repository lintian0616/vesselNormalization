...
## Test the (ΣGPAGs−ΣPPAGs) in METABRIC Validation Dataset (Fig1 c)
...
## Test the (ΣGPAGs−ΣPPAGs) for Relapse in (GSE1456) (Fig1 d)
...
## Test the (ΣGPAGs−ΣPPAGs) for Distant Metastasis in (GSE2990) (Fig1 e)
