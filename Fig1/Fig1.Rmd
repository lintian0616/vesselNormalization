...
## Test the ($\sum$GPAGs - $\sum$PPAGs) in METABRIC Validation Dataset (Fig.1c)
...
## Test the ($\sum$GPAGs - $\sum$PPAGs) for Relapse in (GSE1456) (Fig.1d)
...
## Test the ($\sum$GPAGs - $\sum$PPAGs) for Distant Metastasis in (GSE2990) (Fig.1e)
...
## Correlation of GPAGs and PPAGs with T Cell Activation (Fig.1i)
